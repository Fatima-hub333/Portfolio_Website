...
[Download the ZIP from this location](https://github.com/Fatima-hub333/Portfolio_Website/archive/refs/heads/dev.zip), or run the following [git](https://git-scm.com/downloads) command to clone the files to your machine:

```bash
git clone https://github.com/Fatima-hub333/Portfolio_Website.git
```
